...
```{r compare_vol3m}
compareVols <- function(les, plot=TRUE, excludeICH=FALSE, ...){
...
```{r compare_vol24}
maybeICH24 <- compareVols(les24)
maybeICH24
```

```{r compare_vol24noICH}
noICH24 <- compareVols(les24, excludeICH=TRUE, lty=3, label.curves=FALSE)
noICH24
```
...
## Assemble a concise picture across all 4 imaging times

```{r unified_comparison, fig.height=6.5}
